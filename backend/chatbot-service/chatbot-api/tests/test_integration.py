...
class TestCompleteWorkflows:
    ...
    def test_full_product_discovery_workflow(
        self, client, mock_ollama_chat, mock_vectorstore
    ):
        ...
        search_response = client.post(
            "/search", json={"query": "organic cotton shirt", "top_k": 5}
        )
        ...
        assist_response = client.post(
            "/assist", json={"prompt": "I want an organic cotton t-shirt"}
        )
    ...
    def test_customer_service_workflow(self, client, mock_ollama_chat):
        ...
        scenarios = [
            {"prompt": "What is your return policy?", "expected_intent": "faq"},
            {"prompt": "How long does shipping take?", "expected_intent": "faq"},
            {
        ...
        for scenario in scenarios:
            ...
            response = client.post("/assist", json={"prompt": scenario["prompt"]})
    ...
    def test_mixed_query_workflow(self, client, mock_ollama_chat, mock_vectorstore):
        ...
        queries = [
            # Start with greeting
            {"prompt": "Hello!", "expected_intent": "other", "should_search": False},
            # Ask about products
            {
        ...
        for query in queries:
            ...
            response = client.post("/assist", json={"prompt": query["prompt"]})
...
class TestEdgeCases:
    ...
    def test_unicode_and_special_characters(
        ...
        response = client.post(
            "/assist", json={"prompt": "Je cherche un t-shirt écologique 🌿"}
        )
    ...
    def test_empty_database_search(self, client, mock_vectorstore):
        ...
        response = client.post("/search", json={"query": "any product", "top_k": 5})
