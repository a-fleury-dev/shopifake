...
def test_intent_faq(client, mock_ollama_chat):
    ...
    mock_response = Mock()
    mock_response.json.return_value = {"message": {"content": '{"intent": "faq"}'}}
    mock_ollama_chat.return_value = mock_response
...
def test_intent_other(client, mock_ollama_chat):
    ...
    mock_response = Mock()
    mock_response.json.return_value = {"message": {"content": '{"intent": "other"}'}}
    mock_ollama_chat.return_value = mock_response
...
def test_intent_fallback_regex_parsing(client, mock_ollama_chat):
    ...
    mock_response = Mock()
    mock_response.json.return_value = {
        "message": {"content": "The intent is product_search based on the query"}
    }
    mock_ollama_chat.return_value = mock_response
...
def test_intent_fallback_to_other(client, mock_ollama_chat):
    ...
    mock_response = Mock()
    mock_response.json.return_value = {
        "message": {"content": "This is some random text without intent keywords"}
    }
    mock_ollama_chat.return_value = mock_response
